...
public class AddItem_Servlet extends HttpServlet
{
	...
	{
		MultipartRequest mr = new MultipartRequest(req, "C:\\eclipse-workspace\\website-main\\src\\main\\webapp\\Items");
		...
		bean_admin.Add_Items ob = new bean_admin.Add_Items();
